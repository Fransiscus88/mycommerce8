        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="row" id="productMain">
                    <div class="col-sm-6">
                        <div id="mainImage">
                            <img src="{{ url('img/detailbig1.jpg') }}" alt="" class="img-responsive">
                        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row" id="thumbs">
                            <div class="col-xs-4">
                                <a href="{{ url('img/detailbig1.jpg') }}" class="thumb">
                                    <img src="{{ url('img/detailsquare.jpg') }}" alt="" class="img-responsive">
                                </a>
                            </div>
                            <div class="col-xs-4">
